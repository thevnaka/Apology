...
export const caseData = {
  meta: {
    docketNumber: "DOCKET NO. 2026-CV-0804",
    court: "IN THE HIGH COURT OF PLEASE FORGIVE ME",
    caseTitle: "NISINDI (Plaintiff) v. THEVNAKA (Defendant)",
    status: "PENDING JUDICIAL RATIFICATION",
    filedDate: "AUGUST 4, 2026",
    jurisdiction: "APPELLATE COURT OF \"I REALLY MESSED UP THIS TIME\"",
    presidingJudge: "Her Honor Nisindi, Chief Justice",
    defendant: "Thevnaka (Defendant)"
  },
  ...
  statementOfFacts: {
    title: "EXHIBIT A — SWORN AFFIDAVIT & CONFESSION OF ERROR",
    subtitle: "Solemn Deposition of Defendant Thevnaka Submitted Under Oath",
    body: `COMES NOW the Defendant, Thevnaka, being duly sworn, and for his Deposition states as follows:
...
3. WHEREFORE, Defendant submits this formal Admission of Error, begging the Court's clemency, and praying for an opportunity to make full restitution through the proposed Settlement Agreement attached hereto.`
  ...
  evidenceLocker: [
    {
      id: "ev-1",
      title: "Exhibit B-1 : Trying to eat my Angel's Face",
      category: "PHYSICAL EVIDENCE",
      image: b1Img,
      caption: "Documentary Proof #001: She's my only source of energy no matter what I do. I love her.",
      tag: "CERTIFIED EVIDENCE"
    },
    {
      id: "ev-2",
      title: "Exhibit B-2 : Can't stop kissing my precious baby because she's simply the best",
      category: "PHYSICAL EVIDENCE",
      image: b2Img,
      caption: "Documentary Proof #002: She makes my heart go weee. Gives me butterflies always. She's nothing but the best.",
      tag: "CERTIFIED EVIDENCE"
    },
    {
      id: "ev-3",
      title: "Exhibit B-3: Angel loves Indian and to eat messy food",
      category: "PHYSICAL EVIDENCE",
      image: b3Img,
  ...
  settlementAgreement: {
    title: "PROPOSED CONSENT DECREE & SMART SETTLEMENT AGREEMENT",
    subtitle: "Legally Binding Covenants — Subject to Final Approval by Her Honor Nisindi",
    clauses: [
      {
        id: "clause-1",
        label: "COVENANT 1.1 — Will be Consistent",
        text: "Defendant agrees to be consistent no matter what and do his duties as a good stupid asshole."
      },
      {
        id: "clause-2",
        label: "COVENANT 1.2 — ZERO EXCUSES",
        text: "Defendant permanently waives all rights to plead Excuses."
      },
      {
        id: "clause-3",
        label: "COVENANT 1.3 — Will show the love",
        text: "Defendant agrees to show the love without keeping it to himself and keep proving everyday"
      },
      {
        id: "clause-4",
        label: "COVENANT 1.4 — Won't be too comfortable",
        text: "Defendant guarantees he won't take things lighty and for granted and will do his best no matter what it takes to keep you happy"
      },
      {
        id: "clause-5",
        label: "COVENANT 1.5 — Will not Forget Favors",
        text: "Defendant guarantees he won't ever forget when his baby asks for help from him. He's ready to do anything and everything"
      },
      {
        id: "clause-6",
        label: "COVENANT 1.6 — Will Initiate Everything",
        text: "Defendant agrees he will initiate dates, tick off the bucket list and make sure we explore things together"
      },
      {
        id: "clause-7",
        label: "COVENANT 1.7 — Will make you feel special",
        text: "Defendant guarantees he will be make you feel special, appreciated, loved, valued, cared with his actions and take every little thing into consideration"
      },
      {
        id: "clause-8",
        label: "COVENANT 1.8 — Will Always hold your Hand",
        text: "Defendant guarantees he will hold your hand no matter wherever he goes and will alwaus walk with you and not ahead of you"
      }
    ],
    ...
    apologyLetter: {
      ...
      salutation: "To my Dearest Angel,",
      body: `Before I say anything, I am truly sorry for what I've done. I have not been the best boyfriend and I regret it so much realising how much I've hurt you without knowing. I love you. I love you so much but I was too comfortable to the extent I didn't show it to you.
